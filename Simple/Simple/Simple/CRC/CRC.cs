...
namespace Combat
{
    public class CRC
    {
        ...
        //上面的table[1]就是crc的多项式,crc_policy多项式的值
        private void InitCrcTable(uint crc_policy, uint[] table)
        {
            ...
            //for (int i = 0; i < length; ++i)
            //{
            //    string output = String.Format("{0:X}", table[i]);
            //    LogWrapper.LogError(i, ":", output, "table", table[i]);
            //}
        }
